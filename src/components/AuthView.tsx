...
export const DEFAULT_ADMIN_USER: UserProfile = {
  ...
  email: '',
  role: 'admin',
  avatarUrl: 'https://api.dicebear.com/7.x/bottts/svg?seed=IronBeast&backgroundColor=c0aede,ffdfbf',
  joinedDate: new Date().toISOString().split('T')[0],
  trainingStreakDays: 0,
  totalWorkoutsThisMonth: 0,
  totalVolumeThisMonthKg: 0,
...
export const AuthView: React.FC<AuthViewProps> = ({
  ...
  const handleRegisterSubmit = async (e: React.FormEvent) => {
    ...
    const newUser: UserProfile = {
      ...
      role: 'user',
      avatarUrl: `https://api.dicebear.com/7.x/adventurer/svg?seed=${encodeURIComponent(cleanUsername)}&backgroundColor=ffdfbf,b6e3f4`,
      joinedDate: new Date().toISOString().split('T')[0],
